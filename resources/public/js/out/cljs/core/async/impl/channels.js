...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t74900 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t74900 = (function (val,box,meta74901){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t74900.cljs$lang$type = true;
cljs.core.async.impl.channels.t74900.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t74900";
cljs.core.async.impl.channels.t74900.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t74900");
});
cljs.core.async.impl.channels.t74900.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t74900.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_74902){var self__ = this;
var _74902__$1 = this;return self__.meta74901;
});
cljs.core.async.impl.channels.t74900.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_74902,meta74901__$1){var self__ = this;
var _74902__$1 = this;return (new cljs.core.async.impl.channels.t74900(self__.val,self__.box,meta74901__$1));
});
cljs.core.async.impl.channels.__GT_t74900 = (function __GT_t74900(val__$1,box__$1,meta74901){return (new cljs.core.async.impl.channels.t74900(val__$1,box__$1,meta74901));
});
}
return (new cljs.core.async.impl.channels.t74900(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_74903 = self__.takes.pop();if((taker_74903 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_74903))
{var take_cb_74904 = cljs.core.async.impl.protocols.commit.call(null,taker_74903);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_74904,taker_74903){
return (function (){return take_cb_74904.call(null,null);
});})(take_cb_74904,taker_74903))
);
} else
{}
{
