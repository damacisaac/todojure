...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t60771 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t60771 = (function (val,box,meta60772){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t60771.cljs$lang$type = true;
cljs.core.async.impl.channels.t60771.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t60771";
cljs.core.async.impl.channels.t60771.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t60771");
});
cljs.core.async.impl.channels.t60771.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t60771.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60773){var self__ = this;
var _60773__$1 = this;return self__.meta60772;
});
cljs.core.async.impl.channels.t60771.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60773,meta60772__$1){var self__ = this;
var _60773__$1 = this;return (new cljs.core.async.impl.channels.t60771(self__.val,self__.box,meta60772__$1));
});
cljs.core.async.impl.channels.__GT_t60771 = (function __GT_t60771(val__$1,box__$1,meta60772){return (new cljs.core.async.impl.channels.t60771(val__$1,box__$1,meta60772));
});
}
return (new cljs.core.async.impl.channels.t60771(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_60774 = self__.takes.pop();if((taker_60774 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_60774))
{var take_cb_60775 = cljs.core.async.impl.protocols.commit.call(null,taker_60774);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_60775,taker_60774){
return (function (){return take_cb_60775.call(null,null);
});})(take_cb_60775,taker_60774))
);
} else
{}
{
